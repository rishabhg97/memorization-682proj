...
model_base_name = "./summarise_models/checkpoint-"
...
np.save("bleu_scores_sum_gpt2_final.npy", structured_array)

epochs = list(rg_scores.keys())
scores = np.array(list(rg_scores.values()))
structured_array = np.column_stack((epochs, scores))
np.save("rouge1_scores_sum_gpt2_final.npy", structured_array)